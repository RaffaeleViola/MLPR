...
#         calibrated_scores = calibrate(scores, labels, train_prior)
...
# # Logistic Regression
# scores = calibrate(lr_scores, labels, final_prior)
# name = "LR_calibrated"
# bayes_error_plot(scores, labels, name)
#
# # RBFSVM
# scores = calibrate(rbfsvm_scores, labels, final_prior)
# name = "RBFSVM_calibrated_zscore"
# bayes_error_plot(scores, labels, name)
#
# # TMVG(RAW + zscore)
# scores = calibrate(tmvg_scores, labels, final_prior)
# name = "TMVG_calibrated_zscore"
# bayes_error_plot(scores, labels, name)
#
# # GMMTied K=4
# scores = calibrate(gmm_scores, labels, final_prior)
# name = "GMMTied_calibrated_zscore"
# bayes_error_plot(scores, labels, name)
...
for name, scores in {"TMVG": tmvg_scores, "RBFSVM": rbfsvm_scores, "LR": lr_scores, "GMMTied": gmm_scores}.items():
    calibrated_scores = calibrate(scores, labels, final_prior)
