...
def plot_LR(classifier, lambda_vec, wpoints, name, m, pre_process):
    minDCF = [[[], []], [[], []], [[], []]]
    ...
    fig = plt.figure()
    plt.plot(lambda_vec, minDCF[0][0], color="red", label="p_T = 0.5")
    plt.plot(lambda_vec, minDCF[0][1], color="red", linestyle='dashed', label="p_T = 0.5 - ZSCORE")
    plt.plot(lambda_vec, minDCF[1][0], color="blue", label="p_T = 0.2 ")
    plt.plot(lambda_vec, minDCF[1][1], color="blue", linestyle='dashed', label="p_T = 0.2 - ZSCORE")
    plt.plot(lambda_vec, minDCF[2][0], color="green", label="p_T = 0.8")
    plt.plot(lambda_vec, minDCF[2][1], color="green", linestyle='dashed', label="p_T = 0.8 - ZSCORE")
    plt.xlabel("Lambda")
    plt.ylabel("minDCF")
